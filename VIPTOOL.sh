...
echo -e $g"▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒    "   
echo -e $g"  Hack▒▒▒  e▒▒▒  r▒▒▒ on ▒▒▒  li ▒▒▒  NE ▒▒▒   "
echo -e $g"▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒           " 
echo -e $bl"."
echo -e $bu "________________________________________"
echo -e $bu  " Tools       : VIPTOOl$white          " 
echo -e $bu  " Author      : Hacker.online $white  " 
echo -e $bu  " Contact     : 089655478810 $white " 
...
0) echo -e $bu"WIBU-" 
echo -e $bu"THANK'S"
printf "\e[103m\e[1;77mBY; Hacker.online\e[0m\n"
sleep 2
exit
;;
